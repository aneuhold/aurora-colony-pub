 ...
 * given background color) and packs the PNGs into a single multi-image .ico.
 ...
 * @param backgroundColor - Color used to pad each PNG to square
 */
 ...
 * shorter axis with the supplied background color. librsvg handles the
 ...
 * @param backgroundColor - Color used to pad to square (e.g. `#ffffff`)
 */
export const renderSquarePng = (
  sourceSvg: string,
  size: number,
  outputPath: string,
  backgroundColor: string
